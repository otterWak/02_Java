...
public class PolyService {
	...
	// 자식타입 참조변수 = 자식객체
		...
		Car car3 = new Spark();
		// Spark 객체를 참조하는 변수(car3) 타입이 Car(부모)이기 때문에
		...
		car2.setFuel("전기");
		car2.setWheel(4);
		// car2.setBetterycapacity(000000);
		// 부모타입 참조변수이기 때문에 Tesla의 고유필드, 메서드 사용 불가능
		// The method setBetterycapacity(int) is undefined for the type Car
	...
	public void ex2() {
		...
		System.out.println( arr[1] instanceof Spark ); // flase(Spark와 Tesla는 관계 없음)
	...
	public void ex5() {
		...
		// 프로그램 "실행(ctral + F11) 전"
		// - 컴파일러 toString() 메서드가 Car에 있는걸로 인식해서
		// 	 c1.toString() 호출코드와
