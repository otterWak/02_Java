...
public class ArrayExample1 {
	...
	public void ex1() {
		...
		// new int[3] : heap 영역에 int 3칸짜리 int[] 생성(할당)
		
		// arr = new int[3];
		// int[]     int[] -> 같은 자료형 == 연산 가능
		System.out.println("arr : " + arr); //[I@2ef9b8bc // arr이 가지고 있는 것은 주소값
	...
	public void ex2() {
		...
		// 없는 인덱스 번호인 4에 접근하려해서 발생하는에러
		
		// 배열의 길이 (몇 칸 인가) : 배열명.lnegth
	...
	public void ex5() {
		...
		//jvs에 의해 int형 기본값인 0으로 초기화되어 있음
	...
	public void ex6() {
		...
		System.out.println("오늘 점심 네뉴 : " + arr[(int)(Math.random()*6)]);
	}
	...
	public void ex8() {
		...
		String[] arr = {"사과", "딸시", "바나나", "키위", "멜론", "아보카도"};
		/*
		 * 과일 입력 : 아보카도
		 * 5번 인덱스에 존재
		 * 
	...
	public void ex9() {
		...
		// sc.next(0 -> String 형
		// String.charAt(0) -> String의 0번째 인덱스 문자 하나를 추출해거 char 형태로 반환
		// "h" -> 'h'
