...
public class AbstractionService {
	...
	public void ex1() {
		...
		*/
		...
		honggu.setName("이홍구");
		honggu.setGender('남');
		honggu.setpNo("960317-1******");
		honggu.setAddress("경기도 과천시 부림동");
		honggu.setPhone("010-9179-****");
		honggu.setAge(29);
		
		System.out.println(honggu.getName());
		System.out.println(honggu.getGender());
		System.out.println(honggu.getpNo());
		System.out.println(honggu.getAddress());
		System.out.println(honggu.getPhone());
		System.out.println(honggu.getAge());
