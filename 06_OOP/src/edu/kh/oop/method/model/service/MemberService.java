...
public class MemberService {
	...
	public void displayMenu() {
		...
		do {
			...
			default : System.out.println("잘못 입력하셨습니다.. 메뉴에 있는 번호만 입력해주새요!");
	...
	public String login() {
		...
		if(memberId.equals(memberInfo.getMemberId()) &&
			...
			// loginMember에 memberInfo가 참조하고 있는 객체의 주소를 대입
	...
	// -> 조회하려면?
	// -> 로그인을 했나 안했나 따져보기
	// 1. 로그인 했으면? 현재 로그인한 사람의 정보를 저장하고 있는 객체에서 정보 꺼내오기(이름, 아이디, 나이)
